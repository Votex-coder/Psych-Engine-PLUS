...
class FunkinLua {
	...
	public function new(scriptName:String) {
		...
		//NEW! Lua is present [[PICTURE]]
		/*Lua_helper.add_callback(lua, "setScreenShot", function() {
			if(!ClientPrefs.data.screenshotEnable){
				luaTrace('lmao bro', false, false, FlxColor.RED);
			} else {
				screenshotplugin.ScreenShotPlugin.screenshot();
				hideHud = true;
