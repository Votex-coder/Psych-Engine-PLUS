...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		shotTxt = new Alphabet(0, healthBar.y - 35, "Screenshot Saved!", false);
		shotTxt.setScale(1);
		shotTxt.visible = false;
		add(shotTxt);
		
		/*shotTxt = new FlxText(0, healthBar.y - 35, FlxG.width, "Succefuly Saved \nin Folder mod!", 20);
		shotTxt.setFormat(Paths.font("vcr.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		shotTxt.scrollFactor.set();
		shotTxt.borderSize = 1.25;
		shotTxt.alpha = 0;
		uiGroup.add(shotTxt);*/
